...
이 폴더는 저장소가 물리적인 CD로 읽힐 가능성을 상상하며 만든 문서들을 담고 있습니다.

- `label.txt`: 라벨에 들어갈 수 있는 짧은 문구
- `case-insert.txt`: 케이스 인서트처럼 읽히는 안내
- `sleeve-note.txt`: 슬리브 안쪽에 적힌 짧은 메모
- `volume-id.txt`: 디스크 식별 정보
- `booklet.md`: 영어 부클릿
